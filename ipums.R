...
ipums_field_STATEFIP <- function(data) {
  ...
  canonical <- as.data.frame(read.csv("./ipumsr/variables/states.csv",
...
ipums_field_EDUC <- function(data) {
  ...
  canonical <- as.data.frame(read.csv("./ipumsr/variables/educd.csv", stringsAsFactors = F))
...
ipums_field_OCCSOC <- function(data) {
  ...
  canonical <- as.data.frame(read.csv("./ipumsr/variables/occsoc.csv",
